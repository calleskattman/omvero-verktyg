...
const faqQ1 = "Hur fungerar en ränta-på-ränta kalkylator?";
const faqA1 =
...
const faqQ2 = "Vad betyder ränta på ränta?";
const faqA2 =
...
const faqQ3 = "Hur kan jag räkna ut ränta på ränta på mitt sparande?";
const faqA3 =
...
const faqQ4 = "Vilken ränta ska jag använda i ränta-på-ränta kalkylatorn?";
const faqA4 =
...
const faqQ5 = "Tar ränta-på-ränta kalkylatorn hänsyn till skatt och avgifter?";
const faqA5 =
...
const rantaPaRantaSchema = {
  ...
  "@graph": [
    ...
    },
    {
      ...
      itemListElement: [
        ...
        },
        {
          "@type": "ListItem",
          position: 2,
          name: "Ekonomiska verktyg",
          item: "https://omvero.se/verktyg/ekonomi",
        },
        {
          "@type": "ListItem",
          position: 3,
          name: "Ränta-på-ränta kalkylator",
          item: "https://omvero.se/ranta-pa-ranta-kalkylator",
        },
      ],
    },
    {
    ...
    },
    {
      ...
      name: "Ränta-på-ränta kalkylator",
      description:
        "Beräknar framtida värde baserat på startbelopp, månadssparande, årlig avkastning och spartid.",
      url: "https://omvero.se/ranta-pa-ranta-kalkylator",
      interestRate: {
      ...
      feesAndCommissionsSpecification:
        "Kalkylatorn tar inte hänsyn till skatt, avgifter eller inflation. Resultatet är en förenklad uppskattning.",
      potentialAction: {
        "@type": "CalculateAction",
        name: "Räkna ut ränta på ränta",
        target: "https://omvero.se/ranta-pa-ranta-kalkylator",
        input: [
          {
            "@type": "PropertyValue",
            name: "Startbelopp",
        ...
        result: {
          ...
          name: "Framtida värde",
          description:
            "Det beräknade framtida värdet efter sparperiodens slut.",
          unitText: "SEK",
        },
      },
    },
...
export default function RantaPaRantaKalkylatorPage() {
  return (
    ...
    >
      <>
        {/* Samlat JSON-LD-schema för sidan */}
        <Script
          id="ranta-pa-ranta-full-schema"
          type="application/ld+json"
          strategy="afterInteractive"
          dangerouslySetInnerHTML={{
            __html: JSON.stringify(rantaPaRantaSchema),
          }}
        />

        <div className="space-y-10">
          {/* Kalkylator-sektion */}
          <section aria-labelledby="ranta-pa-ranta-verktyg-rubrik">
            <h2 id="ranta-pa-ranta-verktyg-rubrik" className="sr-only">
          ...
          <section aria-labelledby="ranta-pa-ranta-hur-fungerar">
            <h2
            ...
            <div className="mt-3 space-y-3 text-sm text-slate-700">
              <p>
                ...
                både det du satt in och den ränta du tidigare tjänat. Du fyller
                i startbelopp, hur mycket du sparar löpande, den förväntade
                årliga räntan och hur många år du planerar att spara.
                Kalkylatorn räknar sedan fram ett uppskattat framtida värde med
                ränta-på-ränta-effekt.
              </p>
              <p>
                Principen bakom ränta på ränta är att du låter avkastningen
                stanna kvar och fortsätta arbeta åt dig. Istället för att ta ut
                avkastningen direkt, återinvesteras den och blir en del av
                kapitalet som i sin tur får avkastning. Ju längre tid du låter
                pengarna vara investerade, desto större blir effekten.
              </p>
              <p>
                Med en ränta-på-ränta kalkylator får du en tydligare känsla för
                hur kraftfull tiden är som faktor. Små belopp som investeras
                regelbundet kan växa till stora summor över många år, särskilt
                om avkastningen är hög och du håller nere avgifter och onödiga
                kostnader.
              </p>
            </div>
          </section>
          ...
          {/* Exempel */}
          <section aria-labelledby="ranta-pa-ranta-exempel-rubrik">
            <h2
            ...
            <div className="mt-3 space-y-3 text-sm text-slate-700">
              <p>
                Tänk dig att du sparar 1 000 kronor i månaden i en fond med en
                genomsnittlig avkastning på 7 % per år. Med en
                ränta-på-ränta kalkylator kan du räkna ut att ditt sparande
                efter 10 år kan vara värt runt ett sexsiffrigt belopp, och efter
                20–30 år kan summan bli betydligt större. Större delen av
                slutbeloppet består då av ränta på ränta, inte bara dina egna
                insättningar.
              </p>
              <p>
                Om du istället sätter in ett engångsbelopp, till exempel
                50 000 kronor, och låter det stå med samma ränta kan du se hur
                värdet ökar år för år. Ränta-på-ränta kalkylatorn kan visa hur
                stor skillnad det blir om du låter pengarna jobba i 5, 10, 20
                eller 30 år.
              </p>
              <p>
                Exemplet visar också hur viktigt det är att börja tidigt. Ju
                tidigare du kommer igång, desto längre tid får
                ränta-på-ränta-effekten att verka – och desto större blir
                skillnaden jämfört med att börja spara sent i livet.
              </p>
            </div>
          </section>

          {/* Begränsningar */}
          <section aria-labelledby="ranta-pa-ranta-begransningar-rubrik">
            <h2
            ...
            <div className="mt-3 space-y-3 text-sm text-slate-700">
              <p>
                En ränta-på-ränta kalkylator bygger nästan alltid på förenklade
                antaganden. Den utgår vanligtvis från en jämn årlig avkastning
                och tar inte hänsyn till svängningar på börsen, avgifter,
                inflation eller skatt. Det betyder att verkligt utfall kan bli
                både högre och lägre än det som visas i kalkylen.
              </p>
              <p>
              ...
              <p className="font-semibold">
                ...
                förstå effekten av långsiktigt sparande, men fatta alltid beslut
                utifrån din egen ekonomi, risknivå och tidshorisont.
              </p>
            </div>
          </section>
          ...
          {/* Relaterade verktyg */}
          <section aria-labelledby="ranta-pa-ranta-relaterade-rubrik">
            <h2
